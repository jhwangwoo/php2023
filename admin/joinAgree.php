        ...
        <div class="join__inner">
            ...
            <div class="join__agree">
                <div>
                    ...
                    <label class="agreecheck" for="agree1">
                        <input type="checkbox" id="agree1" class="agree1 agreecheck" name="agree1" value="1" required>
                        J블로그 이용약관
                    </label>
                    ...
                    <label class="agreecheck" for="agree2">
                        <input type="checkbox" id="agree2" class="agree2 agreecheck" name="agree2" value="1" required>
                        개인정보 수집 및 이용 동의
                    </label>
                    <div class="checkbtn">
                        <p class="agreeMsg"></p>
